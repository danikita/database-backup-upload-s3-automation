...
# O RDS usa 'DIFF' internamente na proc rds_backup_database
RDS_TYPE_MAP = {"FULL": "FULL", "DIFFERENTIAL": "DIFF"}
...
def lambda_handler(event, context):
    ...
    try:
        ...
        # rds_backup_database aceita 'FULL' ou 'DIFF' (não 'DIFFERENTIAL')
        rds_type = RDS_TYPE_MAP[BACKUP_TYPE]
